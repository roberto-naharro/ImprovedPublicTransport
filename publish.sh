#!/usr/bin/env bash
# publish.sh — First-time upload of IPT Essentials to Steam Workshop via steamcmd.
#
# Prerequisites:
#   - steamcmd installed
#   - STEAM_USERNAME set in .env
#   - dist/IPTEssentials/ already staged by ./deploy.sh --release
#
# Usage:
#   ./deploy.sh --release
